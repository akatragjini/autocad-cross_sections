...
2. Draw a section **LINE** corresponding to the location of the cross-section.
     ...
     - This tool can cut in the vertical direction (i.e. section line drawn on the xy plane) To cut in the horizontal direction (i.e. elevation) the UCS must be manipulated to flip the model on its side, cut the section then flipped it back again.
